...
use sccp_protocol::{
    ...
    Event as PhoneEvent, HandsetAcknowledgement, HandsetStatusMessage, IncomingRing, IpAddressType,
    LineInstance, MediaEndpoint, MediaEndpointAddress, MediaStatus, MediaTrafficClass,
    MultimediaReceiveDescriptor, MultimediaTransmitControl, MultimediaTransmitDescriptor,
    PARKING_MENU_MAX_ITEMS, ParkingMenuEntry, ParticipantId, PhoneAlarmTelemetry,
